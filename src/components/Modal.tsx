        ...
        <div className="flex flex-col w-full text-white">
          <div className="flex flex-col gap-4">
            <p className="text-sm md:text-base">
              The Coreum No Loss Lottery is a unique opportunity where
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base">
                ...
                <li>
                  Staking rewards are pooled together as the lottery prize
                </li>
                <li>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm md:text-base">
                <li>
                  This is a no-loss lottery - you can always reclaim your
            ...
            <div className="mt-4">
              ...
              {isExampleExpanded && (
                <div className="mt-4 p-4 bg-black/20 rounded-lg">
                  <h3 className="font-bold mb-4">No Loss Lottery Example:</h3>
                  <div className="space-y-2 mb-4">
                    ...
                    <ul className="space-y-1 pl-4">
                      <li>
                        • Wait for the lottery drawing and potentially win the
                        prize pool
                      </li>
